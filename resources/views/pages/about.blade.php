...
@section('content')
    <div class="tm-section about-us-area bg-white tm-padding-section">
        <span class="bg-shape-2"><img src="assets/images/icons/bg-shape-3.png" alt="bg shape 3" /></span>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="about-content about-content-2">
                        <h2>Who we are</h2>
                        <p>
                            s Our philosophy is to provide individualised services for
                            every client. Would we come to Dialia RMT therapy as
                            clients? The profession of Registered Massage Therapy (RMT)
                            has enlarge to become a primary health care modality.
                        </p>
                        <p>
                            Massage therapy can be used for the treatment of both acute
                            and chronic conditions. The purpose of massage is generally
                            for the treatment of body stress or pain. Our services will
                            help you reduce stress, relieve pain from headaches, reduce
                            pain from injuries. Registered Massage Therapy is a safe and
                            natural health care therapy that can help alleviate the
                            discomfort associated with everyday. To book an appointment,
                            please call us at:
                        </p>
                ...
                <div class="col-xl-10 col-12">
                    <div class="tm-missvis">
                        ...
                        <div class="tab-content tm-missvis-tabcontent" id="bstab1-ontent">
                            <div class="tab-pane show active" id="bstab1-area1" role="tabpanel"
                                    ...
                                    <div class="row">
                                                ...
                                                <svg viewBox="0 0 431 335">
                                                    <defs>
                                                        <pattern id="attachedImage2" height="100%" width="100%"
                                                            patternContentUnits="objectBoundingBox">
                                                            <image xlink:href="assets/images/others/mission-image-1.jpg"
                                                                preserveAspectRatio="none" width="1" height="1" />
                                                        </pattern>
                                                    </defs>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="tm-missvis-content">
                                                ...
                                                <p>
                                                    Our Vision is to promote a healthy lifestyle. To
                                                    be a global health care leader by advancing the
                                                    science and practice of massage therapy. In
                                                    supporting our members and serving our
                                                    stakeholders. In supporting our members and
                                                ...
                                                <svg viewBox="0 0 431 335">
                                                    <defs>
                                                        <pattern id="attachedImage3" height="100%" width="100%"
                                                            patternContentUnits="objectBoundingBox">
                                                            <image
                                                                xlink:href="assets/images/heroslider/heroslider-image-1.jpg"
