                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <?php } else { ?>
                                <h4 class="mb-0 font-size-18"><?php echo $main_title; ?>
                                    <small><?php echo $title_small; ?></small></h4>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-sm-right d-none d-sm-block">
                                Copyright © <?= date('Y') ?>. Designed and Developed by <a href="https://utechitpro.com"
                                                                                           target="_blank">UTech IT
                                    Professionals Pvt. Ltd.</a> All rights reserved.
                            </div>
                        </div>
                    </div>
                </div>
